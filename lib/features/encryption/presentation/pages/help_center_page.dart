                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const _HelpTopic(
                        ...
                        note: 'Keep the encrypted copy until you have confirmed that it can be decrypted.',
                      ),
                      const _HelpTopic(
                        ...
                        note: 'A biometric key is linked to the encrypted filename on this device. Renaming the file or clearing app data may prevent automatic key lookup.',
                      ),
                      const _HelpTopic(
                        icon: Icons.hide_image_rounded,
                        title: 'Hide or extract a file',
                        summary: 'Use steganography to place a file inside an image.',
                        steps: [
                        ...
                        note: 'Steganography conceals that data exists; it is not a substitute for encryption. Encrypt sensitive files first.',
                      ),
                      const _HelpTopic(
                        icon: Icons.folder_special_rounded,
                        title: 'Vault and Security',
                        summary: 'Review recent files, protection status, and blocked access attempts.',
                        steps: [
    ...
    return EncryptionSurfaceCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const _NumberedStep(number: 1, text: 'Choose Encrypt, Decrypt, or Stego from Quick actions.'),
          const _NumberedStep(number: 2, text: 'Select the required file and protection method.'),
          const _NumberedStep(number: 3, text: 'Complete processing and download the result.'),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 10),
          Expanded(child: Text(text, style: TextStyle(color: context.encryptoColors.textSecondary, height: 1.4))),
        ],
      ),
    );
  }
...
class _HelpTopic extends StatelessWidget {
  const _HelpTopic({required this.icon, required this.title, required this.summary, required this.steps, this.note});
      ...
      child: ClipRRect(
        ...
        child: Material(
          ...
          child: ExpansionTile(
            ...
            title: Text(title, style: TextStyle(color: context.encryptoColors.textPrimary, fontWeight: FontWeight.w800)),
            subtitle: Text(summary, style: TextStyle(color: context.encryptoColors.textSecondary, height: 1.3)),
            ...
            children: [
              ...
              if (note case final value?)
                Container(
                  ...
                  child: Text('Important: $value', style: TextStyle(color: context.encryptoColors.textPrimary, height: 1.4, fontWeight: FontWeight.w600)),
                ),
            ],
          ),
        ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 10),
                  Expanded(child: Text(tip, style: TextStyle(color: context.encryptoColors.textSecondary, height: 1.4))),
                ],
              ),
            ),
        ],
